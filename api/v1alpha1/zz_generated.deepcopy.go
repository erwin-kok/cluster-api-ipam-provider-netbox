...
func (in *NetboxIPPoolStatus) DeepCopyInto(out *NetboxIPPoolStatus) {
	*out = *in
	if in.Addresses != nil {
		...
		*out = new(NetboxIPPoolStatusIPAddresses)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetboxIPPoolStatusIPAddresses) DeepCopyInto(out *NetboxIPPoolStatusIPAddresses) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetboxIPPoolStatusIPAddresses.
func (in *NetboxIPPoolStatusIPAddresses) DeepCopy() *NetboxIPPoolStatusIPAddresses {
	if in == nil {
		return nil
	}
	out := new(NetboxIPPoolStatusIPAddresses)
